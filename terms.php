...
<div class="container my-5">
        ...
        <p>All content, trademarks, logos, and images provided on Storytails are the intellectual property of the site or its licensors. Unauthorized use is prohibited.</p>

        <h2>4. Limitation of Liability</h2>
        <p>Storytails is not liable for any direct, indirect, incidental, or consequential damages arising from the use or inability to use our website.</p>

        <h2>5. Termination of Access</h2>
        <p>We reserve the right to terminate access to the site without notice if these terms are violated.</p>
